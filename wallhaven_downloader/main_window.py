...
class SettingsDialog(QDialog):
    ...
    def initUI(self):
        ...
        # 下载设置组
        download_group = QGroupBox(self.i18n.t("settings_dialog.download_group"))
        download_layout = QFormLayout()
        
        # API密钥
        self.api_key_edit = HoverableLineEdit()
        download_layout.addRow(self.i18n.t("settings_dialog.api_key") + ":", self.api_key_edit)
        
        # 每页图片数
        self.images_per_page_spin = QSpinBox()
        self.images_per_page_spin.setRange(1, 100)
        self.images_per_page_spin.setValue(24)
        download_layout.addRow(self.i18n.t("settings_dialog.images_per_page") + ":", self.images_per_page_spin)
        ...
        download_layout.addRow(self.i18n.t("settings_dialog.timeout") + ":", self.timeout_spin)
        
        # 并发下载数
        self.concurrent_spin = QSpinBox()
        self.concurrent_spin.setRange(1, 10)
        self.concurrent_spin.setValue(3)
        download_layout.addRow(self.i18n.t("download.concurrent") + ":", self.concurrent_spin)
        
        download_group.setLayout(download_layout)
        glass_layout.addWidget(download_group)
        
        # 界面设置组
        ui_group = QGroupBox(self.i18n.t("settings_dialog.ui_group"))
        ui_layout = QFormLayout()
        
        # 语言设置
        self.language_combo = HoverableComboBox()
        self.language_combo.addItems(["简体中文", "English"])
        ui_layout.addRow(self.i18n.t("settings_dialog.language") + ":", self.language_combo)
        
        self.theme_combo = HoverableComboBox()
        self.theme_combo.addItems([self.i18n.t("theme.light"), self.i18n.t("theme.dark"), self.i18n.t("theme.auto")])
        ui_layout.addRow(self.i18n.t("settings_dialog.theme") + ":", self.theme_combo)
        ...
        ui_layout.addRow(self.i18n.t("settings_dialog.transparency") + ":", transparency_layout)
        
        # 预览图片大小
        self.preview_size_combo = HoverableComboBox()
        self.preview_size_combo.addItems([self.i18n.t("preview_size.small"), self.i18n.t("preview_size.medium"), self.i18n.t("preview_size.large")])
        ui_layout.addRow(self.i18n.t("settings_dialog.preview_size") + ":", self.preview_size_combo)
        ...
        ok_btn = GlassButton(self.i18n.t("settings_dialog.ok"))
        ok_btn.clicked.connect(self.accept)
        button_layout.addWidget(ok_btn)
        
        cancel_btn = GlassButton(self.i18n.t("settings_dialog.cancel"))
    ...
    def getSettings(self):
        ...
        # 主题设置
        theme_list = ["浅色", "深色", "自动"]
        theme = theme_list[self.theme_combo.currentIndex()]
