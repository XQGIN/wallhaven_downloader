...
- 新增壁纸比例筛选功能，支持横向、纵向、正方形等比例筛选
- 优化断点续传功能，改进下载状态保存和恢复机制
- 添加重复文件检测功能，自动跳过已下载的重复文件
- 实现液态玻璃效果界面，提供更美观的视觉体验
- 优化系统托盘功能，支持托盘图标状态显示和右键菜单操作
- 改进下载线程管理，提高并发下载的稳定性和效率
- 新增多种UI组件，包括玻璃效果部件、图片预览部件等
- 添加下载重试机制，采用指数退避策略
- 修复网络环境下的下载失败问题
- 优化设置对话框的选项保存功能
